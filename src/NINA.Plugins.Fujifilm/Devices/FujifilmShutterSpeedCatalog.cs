...
internal static class FujifilmShutterSpeedCatalog
{
    ...
    private static IReadOnlyDictionary<int, double> CreateUniversalMap()
    {
        return new Dictionary<int, double>
        {
            ...
            // Half-stop fractional speeds (XAPI.h XSDK_SHUTTER_*H).
            [44194] = 1.0 / 20.0, [88388] = 1.0 / 10.0, [176776] = 1.0 / 6.0,
            [353553] = 1.0 / 3.0, [2828427] = 3.0, [5656854] = 6.0,
            [11313708] = 10.0, [22627416] = 20.0,

            // Long exposures beyond 30 seconds. Without these the catalog topped out at 60s, so
            // every longer sub-exposure was rejected as an undocumented code and forced onto the
            // bulb path even when the body could time it natively.
            ...
            // T-mode series (XSDK_SHUTTER_2M .. _60M), 2 to 60 minutes.
